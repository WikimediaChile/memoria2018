<template lang="html">
    <div>
        ...
        <app-section :elemento="data.concursos" :metricas="data.concursos.metricas" :images="data.concursos.imagenes">
            ...
            <p>
              <a href="https://commons.wikimedia.org/wiki/Commons:Wiki_Loves_Earth_2018_in_Chile" target="_blank">Wiki Loves Earth Chile</a> fue un concurso fotográfico para capturar los parques nacionales, santuarios de la naturaleza y zonas protegidas de nuestro país. El concurso contó con el apoyo del Servicio Nacional de Turismo y la Corporación Nacional Forestal. Wiki Loves Earth Chile logró recolectar más de 1000 fotografías de nuestros espacios naturales.
            </p>

            <p>
              El <a href="https://es.wikipedia.org/wiki/Wikipedia:Wikiconcurso/Mes_de_Mistral" target="_blank">Mes de Mistral</a> fue un concurso orientado a mejorar los contenidos de Gabriela Mistral en Wikipedia en español, debido a la baja cobertura y extensión de contenidos entre Mistral y Neruda, siendo que ambos ganaron el premio Nobel de Literatura.
            </p>

            <p>
              El concurso <a href="https://meta.wikimedia.org/wiki/Bridges_across_Cultures" target="_blank">Puente entre Culturas</a> vivió su segunda edición. Este concurso tiene por objetivo mejorar los contenidos del mundo asiático en Wikipedia en español, así como se mejoran los contenidos de Latinoamérica en las versiones de Asia.
            </p>

            <p>
              Así mismo, por la cooperación con Iberocoop, Wikimedia Chile se sumó al concurso internacional del mes de la mujer llamado <a href="https://es.wikipedia.org/wiki/Wikipedia:Wikiconcurso/La_mujer_que_nunca_conociste_2018" target="_blank">La Mujer Que Nunca Conociste</a>, evento donde se busca crear y mejorar las biografías de mujeres destacadas en los países integrantes de la iniciativa regional. También nos integramos a la versión de #1bib1ref (1 bibiotecari@, 1 referencia)
            </p>
        </app-section>
