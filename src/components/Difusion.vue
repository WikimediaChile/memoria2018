<template lang="html">
    <div>
        ...
        <app-section :elemento="data.fotos" :metricas="data.fotos.metricas" :images="data.fotos.imagenes">
            <p>A contar de 2016 se ha desarrollado el proyecto de acreditaci&oacute;n para la cobertura fotogr&aacute;fica de eventos deportivos y otras actividades. En 2017 se registraron cuatro eventos de diversa importancia, entre ellos el festival de arte urbano Hecho en Casa Fest y la Telet&oacute;n 2017. En esta &uacute;ltima se cont&oacute; con una acreditaci&oacute;n oficial para ingresar al Teatro Telet&oacute;n, lo cual permiti&oacute; obtener fotograf&iacute;as de artistas, m&uacute;sicos y animadores de televisi&oacute;n que participaron en la jornada, con las que se pudo ilustrar y actualizar distintas biograf&iacute;as en Wikipedia.</p>
            <p>En total, el proyecto ha recopilado 187 fotograf&iacute;as, de las cuales 9 fueron seleccionadas como fotograf&iacute;as de calidad en Wikimedia Commons. Se han usado 46 fotograf&iacute;as distintas en 96 art&iacute;culos en todas las versiones idiom&aacute;ticas de Wikipedia. </p>
        </app-section>
    </div>
</template>
