    ...
    <section id="informacion">
      ...
      <div class="container">
            <dl class="row">
              ...
              <dd class="col-sm-9">Wikimedia Chile</dd>

              <dt class="col-sm-3">Naturaleza jurídica</dt>
              <dd class="col-sm-9">
                <p>Corporación de Derecho Privado, sin fines de lucro, constituida con fecha 16 de julio de 2011 y
                con personalidad jurídica concedida por el decreto N&#176; 4426 exento, del Ministerio de Justicia, de fecha
                12 de septiembre de 2012 y publicado en el Diario Oficial N&#176; 40.372 del día 28 de septiembre de 2012.</p>
              </dd>
              ...
              <dt class="col-sm-3">Directorio 2017 - 2019</dt>
              <dd class="col-sm-9">
                  <dl class="row">
                      <dd class="col-sm-12">Marco Correa Pérez, <strong>Presidente</strong></dd>
                      <dd class="col-sm-12">Rocío Consales, <strong>Vicepresidenta</strong></dd>
                      <dd class="col-sm-12">Carlos Figueroa Rojas, <strong>Secretario</strong></dd>
                      <dd class="col-sm-12">Osmar Valdebenito Gaete, <strong>Tesorero</strong></dd>
                      <dd class="col-sm-12">Claudio Loader, <strong>Director</strong></dd>
                      <dd class="col-sm-12">Dennis Tobar Calderón, <strong>Director</strong></dd>
                  </dl>
              </dd>

              <dt class="col-sm-3">Tribunal de Honor 2017 - 2019</dt>
              <dd class="col-sm-9">
                  <dl class="row">
                      <dd class="col-sm-12">Alexandra Cuevas Heredia, <strong>Presidenta</strong></dd>
                      <dd class="col-sm-12">Daniel Bravo Silva, <strong>Integrante</strong></dd>
                      <dd class="col-sm-12">Sarah Ann Chambers, <strong>Integrante</strong></dd>
                  </dl>
              </dd>

              <dt class="col-sm-3">Participación en iniciativas de cooperación y alianzas</dt>
              <dd class="col-sm-9">
                  <dl class="row">
                      <dd class="col-sm-12">Wikimedia Foundation Inc., <strong>Capítulo local</strong>, <i>desde 13 de junio de 2011</i></dd>
                      <dd class="col-sm-12">Iberocoop, <strong>Integrante de la iniciativa regional</strong>, <i>desde 2010</i></dd>
                  </dl>
              </dd>
